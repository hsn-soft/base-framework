export class HHS {
    ...
    #start(startCallBackFn) {
        ...
        let contentUrlKeyTemp = window.location.pathname ?? "";
        if (window.location.protocol !== "http:" && window.location.protocol !== "https:") {
            contentUrlKeyTemp = window.location.pathname.split("/").reverse()[0];
        }
        ...
        this.#sendRequest(
            "content-service/v1/contents/get-or-create",
            {
                CustomerId: this.appId,
