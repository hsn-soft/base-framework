    ...
    : ApplicationServiceBase(provider), IAnalysisContentAppService
{
    ...
    public async Task<ForceAnalysisVideoGenerationResultDto> ForceAnalysisVideoGenerationQueryAsync(ForceAnalysisVideoGenerationRequestDto input, string correlationId = null) => throw new NotImplementedException();
}