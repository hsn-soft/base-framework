...
public static class MongoDbServiceCollectionExtensions
{
    public static IServiceCollection AddServiceMongoDatabaseConfiguration(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton(sp =>
        {
            ...
            return new FeedRServiceDbContext(sp, configuration);
        });
        ...
        services.AddScoped<INetworkConfigurationRepository, MongoNetworkConfigurationRepository>();
        services.AddScoped<IRawGoogleAdManagerResponseRepository, MongoRawGoogleAdManagerResponseRepository>();
    ...
    private static void RegisterClassMaps()
    {
        ...
        NetworkConfigurationClassMap.Register();
        RawGoogleAdManagerResponseClassMap.Register();
    }
}