...
using Hhs.VideoGeneratorService.Test.Shared.Utils;
using HsnSoft.Base.EventBus;

namespace Hhs.VideoGeneratorService.Test.Functional.NameConversionTests;
...
public class EventNameConversionTests
{
    ...
    {
        var refAssembly = typeof(VideoRequestSendStartedEto).Assembly;
