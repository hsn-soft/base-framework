...
) : IIntegrationEventHandler<VideoFileUploadCompletedEto>
{
    ...
    public async Task HandleAsync(MessageEnvelope<VideoFileUploadCompletedEto> @event)
    {
        ...
        await _videoOperationAppService.HandleVideoUploadCompletedAsync(@event.Message);
    }
}