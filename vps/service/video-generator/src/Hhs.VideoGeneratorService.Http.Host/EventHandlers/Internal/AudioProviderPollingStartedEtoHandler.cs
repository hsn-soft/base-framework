...
) : IIntegrationEventHandler<AudioProviderPollingStartedEto>
{
    ...
    public async Task HandleAsync(MessageEnvelope<AudioProviderPollingStartedEto> @event)
    {
        ...
        await _videoOperationAppService.ScheduleAudioProviderPollingAsync(@event.Message);
    }
}