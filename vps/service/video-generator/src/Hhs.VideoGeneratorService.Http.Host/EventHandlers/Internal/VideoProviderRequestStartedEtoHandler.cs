...
) : IIntegrationEventHandler<VideoProviderRequestStartedEto>
{
    ...
    public async Task HandleAsync(MessageEnvelope<VideoProviderRequestStartedEto> @event)
    {
        ...
        await _videoOperationAppService.StartVideoProviderRequestAsync(@event.Message);
    }
}