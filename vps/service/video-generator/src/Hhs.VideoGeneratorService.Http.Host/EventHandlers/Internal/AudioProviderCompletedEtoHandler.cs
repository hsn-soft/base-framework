...
) : IIntegrationEventHandler<AudioProviderCompletedEto>
{
    ...
    public async Task HandleAsync(MessageEnvelope<AudioProviderCompletedEto> @event)
    {
        ...
        await _videoOperationAppService.HandleAudioProviderCompletedAsync(@event.Message);
    }
}