...
public sealed record CustomerContentNormalizedStartedEto([NotNull] string ScopeKey, [NotNull] string DomainName, Guid CustomerContentId, [NotNull] string DomainPath) : IIntegrationEventMessage
{
