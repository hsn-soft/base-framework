...
public class BaseDateTimeConverter : JsonConverter<DateTime>, ITransientDependency
{
    private readonly IClock _clock;
    private readonly BaseJsonOptions _options;

    public BaseDateTimeConverter(IClock clock, IOptions<BaseJsonOptions> baseJsonOptions)
    {
        _clock = clock;
