...
public class BaseMongoDbDateTimeSerializer : DateTimeSerializer
{
    protected DateTimeKind DateTimeKind { get; set; }
    protected bool DisableDateTimeNormalization { get; set; }

    public BaseMongoDbDateTimeSerializer(DateTimeKind dateTimeKind, bool disableDateTimeNormalization)
    {
