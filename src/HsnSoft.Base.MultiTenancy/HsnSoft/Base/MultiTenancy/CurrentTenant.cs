...
public class CurrentTenant : ICurrentTenant, ITransientDependency
{
    ...
    public IDisposable Change(
        ...
        => SetCurrent(id, isSystemTenant, allowedTenantIds, allowedCustomerIds, allowedScopeKeys, normalized);
        ...
        [CanBeNull] string normalized = null)
    {
        ...
        _currentTenantAccessor.Current = new BasicTenantInfo(tenantId, isSystemTenant, allowedTenantIds, allowedCustomerIds, allowedScopeKeys, normalized);
