    ...
    where TService : IBaseThreadBackgroundService
{
    ...
    protected IBaseLogger Logger { get; }
    ...
    protected BaseMultiThreadBackgroundService(IBaseLogger logger, ushort multiThreadCount = 1, int waitPeriodSeconds = 1, bool waitContinuousThread = false)
    {
        Logger = logger;
