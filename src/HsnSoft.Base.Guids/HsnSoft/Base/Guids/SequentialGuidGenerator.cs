...
/// Use <see cref="BaseSequentialGuidGeneratorOptions"/> to configure.
/// </summary>
public class SequentialGuidGenerator : IGuidGenerator, ITransientDependency
{
    private static readonly RandomNumberGenerator RandomNumberGenerator = RandomNumberGenerator.Create();

    public SequentialGuidGenerator(IOptions<BaseSequentialGuidGeneratorOptions> options)
    {
        Options = options.Value;
    }

    public BaseSequentialGuidGeneratorOptions Options { get; }
