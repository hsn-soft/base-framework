...
public sealed class VideoGenerationApprovedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<VideoGenerationApprovedEto>(inboxStore)
{
...
public sealed class VideoRequestCreatedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<VideoRequestCreatedEto>(inboxStore)
{
...
public sealed class VideoOperationStartedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<VideoOperationStartedEto>(inboxStore)
{
...
public sealed class AudioProviderRequestStartedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<AudioProviderRequestStartedEto>(inboxStore)
{
...
public sealed class AudioFileDownloadStartedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<AudioFileDownloadStartedEto>(inboxStore)
{
...
public sealed class VideoProviderRequestStartedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<VideoProviderRequestStartedEto>(inboxStore)
{
...
public sealed class VideoFileDownloadStartedEtoHandler(VideoGeneratorInboxStore inboxStore, VideoOperationAppService appService) : VideoEventHandlerBase<VideoFileDownloadStartedEto>(inboxStore)
{
