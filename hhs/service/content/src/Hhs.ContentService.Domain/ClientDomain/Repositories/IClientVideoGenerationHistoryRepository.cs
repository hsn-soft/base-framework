...
public interface IClientVideoGenerationHistoryRepository : IReadOnlyGenericRepository<ClientVideoGenerationHistory, Guid>
{
    ...
    Task<ClientVideoGenerationHistory> CreateAsync(Guid tenantId, Guid clientId, DateTime videoGenerationDate, VideoGenerationTypes videoGenerationType, [NotNull] string contentReferenceIds);
}