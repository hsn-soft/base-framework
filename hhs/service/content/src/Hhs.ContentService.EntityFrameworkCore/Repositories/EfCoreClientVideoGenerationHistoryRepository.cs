...
public sealed class EfCoreClientVideoGenerationHistoryRepository : EfCoreGenericRepository<ClientVideoGenerationHistory, Guid>, IClientVideoGenerationHistoryRepository
{
    ...
    public async Task<ClientVideoGenerationHistory> CreateAsync(Guid tenantId, Guid clientId, DateTime videoGenerationDate, VideoGenerationTypes videoGenerationType, string contentReferenceIds)
    {
