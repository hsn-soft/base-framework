...
internal static class DbContextFactoryHelper
{
    ...
    internal static string GetConnectionStringFromConfiguration()
        ...
        // => "Host=hhsahin.com;Port=35432;Database=Hhs_FeedRService;User ID=postgres;Password=postgres;Pooling=true;Connection Lifetime=0;";

    private static IConfigurationRoot BuildConfiguration()
    {
        const string serviceName = "FeedRService.AdManager";
