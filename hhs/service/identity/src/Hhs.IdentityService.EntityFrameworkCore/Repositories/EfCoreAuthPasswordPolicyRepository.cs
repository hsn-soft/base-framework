...
public class EfCoreAuthPasswordPolicyRepository : EfCoreGenericRepository<AuthPasswordPolicy, Guid>, IAuthPasswordPolicyRepository
{
    ...
    public EfCoreAuthPasswordPolicyRepository(
