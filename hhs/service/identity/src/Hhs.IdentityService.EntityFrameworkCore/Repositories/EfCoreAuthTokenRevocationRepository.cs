...
public class EfCoreAuthTokenRevocationRepository : EfCoreGenericRepository<AuthTokenRevocation, Guid>, IAuthTokenRevocationRepository
{
    ...
    public EfCoreAuthTokenRevocationRepository(
