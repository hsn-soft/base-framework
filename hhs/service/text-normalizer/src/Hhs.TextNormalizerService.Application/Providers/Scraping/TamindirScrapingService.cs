...
public sealed class TamindirScrapingService(Uri targetUri, IAppConsoleLogger logger, IPuppeteerBrowser puppeTeer) : BaseScrapingService(targetUri, logger, puppeTeer)
{
    ...
    private const string ImageScript = "() => Array.from(document.querySelectorAll('.post-content .post-image .container img'), (e) => e.getAttribute('src'))";
