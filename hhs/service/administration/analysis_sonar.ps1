...
dotnet sonarscanner begin `
    /k:"hhs-service-content" `
    /d:sonar.host.url="http://localhost:8031" `
    /d:sonar.login="`sqp_f354df28e8efa862516470d1ce4bac7dd681e999" `
    /o:"hsnsh" `
...
" "
## SONAR END --------------------------------------------------------------------------------
dotnet sonarscanner end /d:sonar.login="`sqp_f354df28e8efa862516470d1ce4bac7dd681e999"
" "
