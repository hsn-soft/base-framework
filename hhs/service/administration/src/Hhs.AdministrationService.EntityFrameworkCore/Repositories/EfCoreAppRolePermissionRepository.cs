...
public class EfCoreAppRolePermissionRepository : EfCoreGenericRepository<AppRolePermission, Guid>, IAppRolePermissionRepository
{
    [NotNull] private IStringLocalizer L { get; }

    public EfCoreAppRolePermissionRepository(
