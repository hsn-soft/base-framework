...
using Hhs.AdministrationService.Setup;
...
builder.Services.AddMicroserviceHosting(builder.Configuration, typeof(Program))
    ...
    .AddCustomAuthorization(AdministrationServicePermissions.GetAll())
    ...
    .AddServiceEfCoreDatabaseConfiguration(builder.Configuration);
...
try
{
    ...
    {
        { nameof(SynchAllPermissionToCacheDbEto), 1 }
    });
