...
public static class StaticData
{
    ...
    public static IEnumerable<string> AllPermissions()
    {
        var allServicePermissions = MenuPermissionMapDatas
            .Where(x => x.PermissionType == PermissionTypes.LeafMenuPermission)
        ...
        allServicePermissions.AddRange(TenantServicePermissions.GetAll());
        ...
        allServicePermissions.AddRange(TenantOperationPermissions.GetAll());
    ...
    {
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Dashboards.Summary, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Dashboards.Summary}{WebChannelMenu.LeafPermissionName}", 10),
        ...
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Dashboards.Traffic, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Dashboards.Traffic}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.Contents, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.Contents}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.Visits, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.Visits}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VideoPlatformOverview, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VideoPlatformOverview}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VideoPlatformAnalysisVideo, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VideoPlatformAnalysisVideo}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VideoPlatformSpecialVideo, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VideoPlatformSpecialVideo}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VideoPlatformCreateAVideo, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VideoPlatformCreateAVideo}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VideoPlatformReporting, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VideoPlatformReporting}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.VerticalVideo, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.VerticalVideo}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.Podcast, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.Podcast}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.AdWall, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.AdWall}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.ContentManagement.BiddingTech, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.ContentManagement.BiddingTech}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.InvoiceManagement.Invoices, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.InvoiceManagement.Invoices}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.InvoiceManagement.CostAnalysis, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.InvoiceManagement.CostAnalysis}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Reporting.TrendContentReport, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Reporting.TrendContentReport}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Reporting.AnalysisContentReport, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Reporting.AnalysisContentReport}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Contents, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Contents}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Inventory.Codes, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Inventory.Codes}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Payments.List, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Payments.List}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Payments.Detail, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Payments.Detail}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Invoice.List, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Invoice.List}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Invoice.Detail, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Invoice.Detail}{WebChannelMenu.LeafPermissionName}", 10),
        ...
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.TenantManagement.Clients, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.TenantManagement.Clients}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.TenantManagement.Clients, PermissionTypes.ActionPermission, ContentServicePermissions.Clients.PageView, 11),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.TenantManagement.Clients, PermissionTypes.ActionPermission, ContentServicePermissions.Clients.Create, 12),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.TenantManagement.Clients, PermissionTypes.ActionPermission, ContentServicePermissions.Clients.Update, 13),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.TenantManagement.Clients, PermissionTypes.ActionPermission, ContentServicePermissions.Clients.Delete, 14),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.IdentityManagement.Roles}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, IdentityServicePermissions.AppRoles.PageView, 11),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, IdentityServicePermissions.AppRoles.Create, 12),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, IdentityServicePermissions.AppRoles.Update, 13),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, IdentityServicePermissions.AppRoles.Delete, 14),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, AdministrationServicePermissions.RolePermissions.PageView, 15),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Roles, PermissionTypes.ActionPermission, AdministrationServicePermissions.RolePermissions.Manage, 16),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.IdentityManagement.Users}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.ActionPermission, IdentityServicePermissions.AppUsers.PageView, 11),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.ActionPermission, IdentityServicePermissions.AppUsers.Create, 12),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.ActionPermission, IdentityServicePermissions.AppUsers.Update, 13),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.OperationPermission, IdentityOperationPermissions.AppUsers.UpdateEmail, 14),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.OperationPermission, IdentityOperationPermissions.AppUsers.UpdatePhone, 15),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.OperationPermission, IdentityOperationPermissions.AppUsers.UpdateIsBlock, 16),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.Users, PermissionTypes.ActionPermission, IdentityServicePermissions.AppUsers.Delete, 17),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.AuditLogs, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.IdentityManagement.AuditLogs}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IdentityManagement.AuditLogs, PermissionTypes.ActionPermission, IdentityServicePermissions.AuditLogs.PageView, 11),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.PublisherManagement.List, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.PublisherManagement.List}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.PublisherManagement.SettingsMenu, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.PublisherManagement.SettingsMenu}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.PublisherManagement.AddPublisher, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.PublisherManagement.AddPublisher}{WebChannelMenu.LeafPermissionName}", 10),
        new(AppUiNames.BackOfficeClientId, WebChannelMenu.PublisherManagement.AddUser, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.PublisherManagement.AddUser}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.IntegrationManagement.DomainCodes, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.IntegrationManagement.DomainCodes}{WebChannelMenu.LeafPermissionName}", 10),

        new(AppUiNames.BackOfficeClientId, WebChannelMenu.Account.Settings, PermissionTypes.LeafMenuPermission, $"{WebChannelMenu.Account.Settings}{WebChannelMenu.LeafPermissionName}", 10),
    };
