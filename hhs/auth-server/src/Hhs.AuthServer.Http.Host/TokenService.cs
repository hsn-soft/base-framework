...
//         if (user != null)
//         {
//             string displayName = (user.Name ?? string.Empty) + (user.Surname != null ? " " + user.Surname : "");
...
//
//                 new("user_lg", user.DefaultLanguage ?? string.Empty),
//                 new(BaseClaimTypes.TenantDomain, user.TenantDomain ?? string.Empty),
//                 new(BaseClaimTypes.TenantId, user.TenantId.ToString()),
//
//                 new("given_name", user.Name ?? string.Empty),
//                 new("family_name", user.Surname ?? string.Empty),
