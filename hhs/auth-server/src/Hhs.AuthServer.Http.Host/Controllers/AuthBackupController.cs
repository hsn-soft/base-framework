...
public sealed class AuthController : BaseServiceController //, IAuthAppService
{
    ...
    public AuthController(TokenService tokenService, IServiceProvider provider, RedisService redis,
        ...
        IDataFilter dataFilter, IAuthLoginAuditRepository authLoginAuditRepository, IAuthPasswordPolicyRepository authPasswordPolicyRepository, IAuthRefreshTokenRepository authRefreshTokenRepository) : base(provider)
    {
