...
internal static class SeedRoles
{
    public static List<SeedRole> Roles => new()
    {
        ...
        new SeedRole { RoleId = Guid.Parse("2D085C6D-370F-4FDC-9BCA-0330FF0DFA2E"), Name = $"{IdentityConsts.Admin}#technotoday", TenantDomain = "technotoday", TenantId = Guid.Parse("f25a1a33-8fd9-4652-98e1-c354a4201717") },
        new SeedRole { RoleId = Guid.Parse("f6b8b776-9f17-4f73-ac2b-17d7a153e4fb"), Name = $"{IdentityConsts.Admin}#sondakika", TenantDomain = "sondakika", TenantId = Guid.Parse("59e368a4-7d4a-419b-9e74-2f517ed65af7") },
        new SeedRole { RoleId = Guid.Parse("46f859a8-0737-452a-8fd6-258156fdf901"), Name = $"{IdentityConsts.Admin}#t24", TenantDomain = "t24", TenantId = Guid.Parse("f05ad9c0-52c7-4ad8-8349-1f4bcc1b9bf9") },
        new SeedRole { RoleId = Guid.Parse("2901aeaf-b3cc-41c9-936e-897a5502879e"), Name = $"{IdentityConsts.Admin}#cnbce", TenantDomain = "cnbce", TenantId = Guid.Parse("fe3078f2-ab3a-49a4-96b1-8eb9069afe4a") },
        new SeedRole { RoleId = Guid.Parse("d09e458b-9b42-4894-9bc2-349ad54cbf2a"), Name = $"{IdentityConsts.Admin}#boxofficeturkiye", TenantDomain = "boxofficeturkiye", TenantId = Guid.Parse("6f3727b8-019d-4de0-8c0a-00758e04ae1c") },
    };
}
