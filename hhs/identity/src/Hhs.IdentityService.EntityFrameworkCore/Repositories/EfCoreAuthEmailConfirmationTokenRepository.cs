...
public class EfCoreAuthEmailConfirmationTokenRepository : EfCoreGenericRepository<AuthEmailConfirmationToken, Guid>, IAuthEmailConfirmationTokenRepository
{
    ...
    public EfCoreAuthEmailConfirmationTokenRepository(
