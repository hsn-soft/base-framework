...
public class EfCoreAuthLoginAuditRepository : EfCoreGenericRepository<AuthLoginAudit, Guid>, IAuthLoginAuditRepository
{
    ...
    public EfCoreAuthLoginAuditRepository(
