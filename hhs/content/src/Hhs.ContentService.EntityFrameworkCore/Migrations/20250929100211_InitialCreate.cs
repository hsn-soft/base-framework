        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubdomainName = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContentReferenceIds = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppContents_ClientId_SlugKey",
                table: "AppContents",
                columns: new[] { "ClientId", "SlugKey" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientVideoGenerationHistories_ClientId",
