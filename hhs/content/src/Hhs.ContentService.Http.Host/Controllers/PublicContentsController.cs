...
public sealed class PublicContentsController : BaseServiceController
{
    ...
    public PublicContentsController(IServiceProvider provider, IAppContentPublicAppService appContentPublicAppService, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment environment, IAppContentAppService appContentAppService) : base(provider)
    {
