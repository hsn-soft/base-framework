...
[Route("api/content-service/v1/commercial/contents")]
public sealed class ContentsController : BaseServiceController
{
    ...
    public ContentsController(IServiceProvider provider, IAppContentPublicAppService appContentPublicAppService, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment environment) : base(provider)
    {
    ...
    public async Task<AppContentDto> GetContentAsync(Guid id) => await _appContentPublicAppService.GetAsync(id);
